...
public class EvaluarMejorada {
	...
	public void testPruebagrado4() throws IOException {
		...
		assertEquals(2685.48, pol.evaluarMejorada(5), pol.normaCoeficientes());
	}
	...
	public void testPruebagrado9() throws IOException {
		...
		assertEquals(8565573.34, pol.evaluarMejorada(5), pol.normaCoeficientes());
	}
	...
	public void testPruebagrado19() throws IOException {
		...
		assertEquals(8.364818571401083E13, pol.evaluarMejorada(5), pol.normaCoeficientes());
	}
	...
	public void testPruebagrado29() throws IOException {
		...
		assertEquals(8.168768136133957E20, pol.evaluarMejorada(5), pol.normaCoeficientes());
	}
	...
	public void testPruebagrado49() throws IOException {
		...
		assertEquals(7.635469317744624E34, pol.evaluarMejorada(5), pol.normaCoeficientes());
	}
	...
	public void testPruebagrado59() throws IOException {
		...
		assertEquals(7.456513005609984E41, pol.evaluarMejorada(5), pol.normaCoeficientes());
	}
	...
	public void testPruebagrado99() throws IOException {
		...
		assertEquals(6.781659072303221E69, pol.evaluarMejorada(5), pol.normaCoeficientes());
	}
	...
	public void testPruebPolinomioImpar() throws IOException {
		...
		assertEquals(487.0, pol.evaluarMejorada(5), pol.normaCoeficientes());
	}
}
