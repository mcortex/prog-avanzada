...
public class EvaluarProgDinamica {
	@Test
	public void testPruebagrado4() throws IOException {
		...
		assertEquals(2685.48, pol.evaluarProgDinamica(5), 0.001);
	}
	...
	public void testPruebagrado9() throws IOException {
		...
		assertEquals(8565573.34, pol.evaluarProgDinamica(5), 0.001);
	}
	...
	public void testPruebagrado19() throws IOException {
		...
		assertEquals(8.364818571401083E13, pol.evaluarProgDinamica(5), 0.001);
	}
	...
	public void testPruebagrado29() throws IOException {
		...
		assertEquals(8.168768136133957E20, pol.evaluarProgDinamica(5), 0.001);
	}
	...
	public void testPruebagrado49() throws IOException {
		...
		assertEquals(7.635469317744624E34, pol.evaluarProgDinamica(5), 0.001);
	}
	...
	public void testPruebagrado59() throws IOException {
		...
		assertEquals(7.456513005609984E41, pol.evaluarProgDinamica(5), 0.001);
	}
	...
	public void testPruebagrado99() throws IOException {
		...
		assertEquals(6.781659072303221E69, pol.evaluarProgDinamica(5), 0.1);
	}
	...
	public void testPruebPolinomioImpar() throws IOException {
		...
		assertEquals(487.0, pol.evaluarProgDinamica(5), 0.1);
	}
}
