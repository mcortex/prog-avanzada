...
public class EvaluarRecursiva {
	...
	public void testPruebagrado4() throws IOException {
		...
		assertEquals(2685.48, pol.evaluarRecursiva(5), 0.1);
	}
	...
	public void testPruebagrado9() throws IOException {
		...
		assertEquals(8565573.34, pol.evaluarRecursiva(5), 0.01);
	}
	...
	public void testPruebagrado19() throws IOException {
		...
		assertEquals(8.364818571401083E13, pol.evaluarRecursiva(5), 0.01);
	}
	...
	public void testPruebagrado29() throws IOException {
		...
		assertEquals(8.168768136133957E20, pol.evaluarRecursiva(5), 0.001);
	}
	...
	public void testPruebagrado49() throws IOException {
		...
		assertEquals(7.635469317744624E34, pol.evaluarRecursiva(5), 0.001);
	}
	...
	public void testPruebagrado99() throws IOException {
		...
		assertEquals(6.781659072303221E69, pol.evaluarRecursiva(5), 0.001);
	}
	...
	public void testPruebPolinomioImpar() throws IOException {
		...
		assertEquals(487.0, pol.evaluarRecursiva(5), 0.001);
	}
